/*
  ...
  - You are about to drop the column `bucketItemId` on the `Comment` table. All the data in the column will be lost.
  - You are about to drop the column `createdDate` on the `Comment` table. All the data in the column will be lost.
  - You are about to drop the column `updatedDate` on the `Comment` table. All the data in the column will be lost.
